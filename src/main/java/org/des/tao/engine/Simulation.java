...
public abstract class Simulation {
    ...
    protected File traceOutput;

    protected double clock;
    protected int scheduledEventCount;
    protected int pendingEventCount;

    public Simulation() throws NoSuchMethodException {
    ...
    protected void setTraceOutput(File traceOutput) {
    ...
    protected void schedulePendingEvent(
        ...
        pendingEvents.add(new PendingEvent(
                pendingEventCount++, eventPriority,
    ...
    public void startSimulation(double finishTime) {
        ...
        try {
            traceWriter = new PrintWriter(new FileWriter(traceOutput));
        } catch (Exception e) {
        ...
        while (!scheduledEvents.isEmpty()) {
            ...
            if (currentEvent.getScheduledTime() > finishTime) break;
    ...
    protected abstract void traceState(
            PrintWriter traceWriter, double clock, String eventName);
